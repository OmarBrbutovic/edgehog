...
defmodule Edgehog.Devices.Device.ManualActionsEdgeTest do
  ...
  describe "SetLedBehavior.update/3" do
  ...
  describe "SendApplicationCommand.update/3" do
    test "returns error for unknown deployment command" do
      changeset = %Ash.Changeset{
        arguments: %{command: :unknown_command, release: %{id: "rel-1"}, device: %{id: "dev-1"}},
        data: %{},
        action_type: :update
      }
