...
defprotocol Edgehog.Campaigns.CampaignMechanism.Core do
  ...
  def mark_campaign_in_progress!(mechanism, campaign)
  def mark_campaign_in_progress!(mechanism, campaign, time)
  def mark_campaign_as_failed!(mechanism, campaign)
  def mark_campaign_as_failed!(mechanism, campaign, time)
  def mark_campaign_as_successful!(mechanism, campaign)
  def mark_campaign_as_successful!(mechanism, campaign, time)
  ...
  def mark_target_as_failed!(mechanism, target)
  def mark_target_as_failed!(mechanism, target, time)
  def mark_target_as_successful!(mechanism, target)
  def mark_target_as_successful!(mechanism, target, time)
  def update_target_latest_attempt(mechanism, target)
  def update_target_latest_attempt(mechanism, target, time)
  def pending_request_timeout_ms(mechanism, target)
  def pending_request_timeout_ms(mechanism, target, time)
...
defimpl Edgehog.Campaigns.CampaignMechanism.Core, for: Any do
  ...
  Expected values are `:scheduled`, `:idle`, `:in_progress`, `:pausing`, `:paused` or `:finished`.
