...
import type { DeploymentCampaign_cancelCampaign_Mutation } from "@/api/__generated__/DeploymentCampaign_cancelCampaign_Mutation.graphql";
...
const CANCEL_CAMPAIGN_MUTATION = graphql`
  mutation DeploymentCampaign_cancelCampaign_Mutation($id: ID!) {
...
const CampaignActions = ({
  ...
  const [cancelCampaign, isCancelling] =
    useMutation<DeploymentCampaign_cancelCampaign_Mutation>(
  ...
  const handleCancelCampaign = useCallback(() => {
    cancelCampaign({
      ...
      onError() {
        setErrorFeedback(
          <FormattedMessage
            id="pages.DeploymentCampaign.cancelErrorFeedback"
            defaultMessage="Could not cancel the campaign, please try again."
          />,
        );
      },
    });
  }, [deploymentCampaignId, cancelCampaign, setErrorFeedback]);
    ...
    return (
      <>
        ...
        >
          ...
          <FormattedMessage
            id="pages.DeploymentCampaign.cancelButton"
...
const DeploymentCampaignContent = ({
  ...
  const queryData = usePreloadedQuery<DeploymentCampaign_getCampaign_Query>(
    GET_CAMPAIGN_QUERY,
    getCampaignQuery,
  );
